...
// Bilder für COllection oder so
import Eskimo from "../bilder/Eskimo.jpg";
import Ziegelei from "../bilder/Ziegelei.jpg";
import Villa from "../bilder/Villa.jpg";
import Schule from "../bilder/Schule.jpg";
import Badi from "../bilder/Badi.jpg";
import Töss from "../bilder/Töss.jpg";
import Pickanto from "../bilder/Pickanto.jpg";
import Weiher from "../bilder/Weiher.jpg";
import Wald from "../bilder/Wald.jpg";
import bhf from "../bilder/bhf.jpg";
import shop from "../bilder/shop.jpg";
import schenker from "../bilder/schenker.jpg";
import bach from "../bilder/bach.jpg";
import multberg from "../bilder/multberg.jpg";
...
function Pfungen() {
  const images = [
    Image1, Eskimo, Ziegelei, Villa, Schule, Badi, Töss, Pickanto, Weiher, Wald, bhf, shop, schenker, bach, multberg
  ];
